                            ...
                            <div class="well with-header  with-footer">
                                ...
                                <div class="col-lg-12" style="padding-bottom: 20px;">
                                    ...
                                    <?php
                                        ...
                                        $nilai   =   mysql_query("SELECT level.nm_level, pelajaran.pelajaran_nama, tahun.tahun_nama, nilai.nilai_poin 
                                                                FROM nilai 
                                                                ...
                                                                WHERE pelajaran.pelajaran_id='$pelajaran_id' AND level.level_id='$level_id' AND tahun.tahun_id='$tahun_id'
                                                                ORDER BY pelajaran.pelajaran_id ASC");
