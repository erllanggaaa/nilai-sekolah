                ...
                <form class="form-horizontal" role="form" method="POST">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <label class="col-sm-0 control-label "><?php echo $row['name']; ?></label>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <label class="col-sm-1 control-label ">:</label>
                            <label class="col-sm-0 control-label "><?php echo $row['username']; ?></label>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <label class="col-sm-1 control-label ">:</label>
                            <label class="col-sm-0 control-label "><?php echo $row['jenis_kelamin']; ?></label>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <label class="col-sm-1 control-label ">:</label>
                            <label class="col-sm-0 control-label "><?php echo $row['status']; ?></label>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <label class="col-sm-1 control-label ">:</label>
                            <label class="col-sm-0 control-label "><?php echo $row['alamat']; ?></label>
                        </div>
                    </div>
                    <hr/>
                    <div class="form-group">
