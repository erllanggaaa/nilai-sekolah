...
<?php
        ...
        }elseif ($_SESSION['access'] == 'pembimbing' OR 'admin') {
            if (isset($_POST['cari-nilai'])) {
            ...
            <div id="horizontal-form">
                <form class="form-horizontal" role="form" method="POST">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select id="e1" style="width:100%;" name="pelajaran_id" required>
                                <?php 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select id="e2" style="width:100%;" name="level_id" required>
                                <?php 
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label no-padding-right">Nama</label>
                        <div class="col-sm-10">
                            <select id="e3" style="width:100%;" name="id" required>
                                <?php 
                                    $users  =   mysql_query("SELECT * FROM users WHERE access='siswa'");
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label no-padding-right">Tahun Ajaran</label>
                        <div class="col-sm-10">
                            <select id="e4" style="width:100%;" name="tahun_id" required>
                                <?php 
                                    $tahun  =   mysql_query("SELECT * FROM tahun");
