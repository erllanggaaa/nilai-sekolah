            ...
            <div id="horizontal-form">
                <form class="form-horizontal" role="form" method="POST">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="tahun_nama" value="<?php echo $row['tahun_nama']; ?>" placeholder="Tahun Ajaran" required>
                        </div>
                    </div>
                    <hr/>
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            ...
                            <button class="btn btn-warning"><a href="?akademik=tahun">Batal</a></button>
                        </div>
                    </div>
                </form>
            </div>
