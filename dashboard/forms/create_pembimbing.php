<div class="col-lg-12 col-sm-12 col-xs-12">
    <div class="widget">
        <div class="widget-header bordered-bottom bordered-lightred">
            <span class="widget-caption">Pembimbing Form</span>
        </div>
        <div class="widget-body">
            <div id="horizontal-form">
                <form class="form-horizontal" role="form" method="POST">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label no-padding-right">Access</label>
                        <div class="col-sm-10">
                            <select id="e3" style="width:100%;" name="access" required readonly>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <button type="submit" class="btn btn-primary" name="create-pembimbing">Create</button>
