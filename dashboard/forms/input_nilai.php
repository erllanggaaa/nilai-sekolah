            ...
            <div id="horizontal-form">
                <form class="form-horizontal" role="form" method="POST">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select id="e1" style="width:100%;" name="level_id" required>
                                <?php 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select id="e4" style="width:100%;" name="id" required>
                                <?php 
                                    $users  =   mysql_query("SELECT * FROM users WHERE access='siswa'");
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select id="e5" style="width:100%;" name="tahun_id" required>
                                <?php 
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label no-padding-right">Nilai</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="nilai_poin" placeholder="Nilai" required>
                        </div>
                    </div>
                    <hr/>
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <button type="submit" class="btn btn-primary" name="input-nilai">Input</button>
